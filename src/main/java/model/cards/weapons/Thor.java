...
public class Thor extends WeaponOptional2 {
    ...
    public Thor(String name,Ammo pickUpCost, Ammo baseCost, Ammo optionalCost1,Ammo optionalCost2, int baseDamage,
    ...
    public void askBaseRequirements(Player currentPlayer) {
        if(getModel().getCurrent().getBaseCounter() == 0) {
            baseTarget = null;
            //get all the players that the current player can see
    ...
    public void askOptionalRequirements1(Player currentPlayer) {
        if(getModel().getCurrent().getOptionalCounter1()==0){
            ...
            baseTarget = player;
            //gets all the players that the target selected during the base fire mode can see
    ...
    public void askOptionalRequirements2(Player currentPlayer) {
        if(getModel().getCurrent().getOptionalCounter2()==0){
            //gets all the players that the target selected during the first optional fire mode can see
